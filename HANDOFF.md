...
- **§8.3-UI sotto-tranche 3b — chiusa il 2026-04-26**. Tutti i pezzi residui (notebook curator paginato, CRUD utenti via UI admin) sono atterrati. La UI tutor + admin del pilota è completa per l'uso. Eventuali estensioni (riattivare utenti disattivati, cambio role, mostrare utenti disabilitati con toggle) restano fuori scope finché non emergono.
