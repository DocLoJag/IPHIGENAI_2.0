...
- [x] Upload UI — fatto §8.6-st2 (2026-04-25). Paperclip nel composer chat AI + sezione "Allegati" nel pannello tutor con thumbnail e cancella + pagina `/files` lato studente con voce in topbar. Atterrata in due PR parallele (PR #5 = chat AI + sezione tutor, questa PR = `/files` + backend fix lista uploads incrociata). Manca: integrazione AI come `image`/`document` content block all'Anthropic (§8.6-st3).
