...
- [ ] **§8.3-UI sotto-tranche 3b residuo (resta)** — CRUD utenti via UI admin (oggi solo via curl). Rimandato fino a richiesta d'uso reale.
...
- **§8.3-UI sotto-tranche 3b residuo (resta)** — CRUD utenti via UI admin (oggi via curl). Da fare quando l'uso reale lo richiede. (St3a — ripristino scartati — già fatta; st3b parziale — UI admin minimale — già fatta; notebook curator paginato — già fatto il 2026-04-26.)
